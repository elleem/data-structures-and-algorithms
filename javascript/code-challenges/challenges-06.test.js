...
const getNames = (arr) => {
  // use map to return an array with the names reversed
 let reverse = arr.map((e)=>{
...
const appendTheEnd = (str) => {
  // appends ' The end.' to a string, and returns the modified string
  let end = str + ' The end.';
  return end;
};
...
const addBirthYearProperty = (obj, year) => {
  // accepts an object and an integer as arguments and adds a new property to the object called yearBorn
  obj.yearBorn= year;
};
